...
export const EVENT_LABELS: Record<string, string> = {
  ...
  select_gift_category_her: "Категория подарка — для неё",
  select_gift_category_home: "Категория подарка — для дома",
  select_gift_category_auto: "Категория подарка — для авто",
  click_gift_category_cta: "Кнопка «Подобрать подарок»",
