  ...
  try {
    ...
    await prisma.catalogSettings.update({
      ...
      data: {
        ...
        giftCategoryTitle: data.giftCategoryTitle || null,
        giftCategoryDescription: data.giftCategoryDescription || null,
        giftForHerTitle: data.giftForHerTitle || null,
        giftForHerItems: data.giftForHerItems || null,
        giftHomeTitle: data.giftHomeTitle || null,
        giftHomeItems: data.giftHomeItems || null,
        giftAutoTitle: data.giftAutoTitle || null,
        giftAutoItems: data.giftAutoItems || null,
        giftCategoryCtaText: data.giftCategoryCtaText || null,
